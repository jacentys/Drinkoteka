...
**Wciąż do zrobienia**: zrzuty ekranu (wymagane do pełnego App Store listing, niekoniecznie do samego TestFlight), sprawdzenie czy External Testing wymaga ponownego Beta App Review dla builda 3 (StoreKit + bez iPada), oczekiwanie na wynik.
