...
**Wciąż do zrobienia**: submitować build `1.0 (4)` do grupy External Testing i wysłać do Beta App Review, tym razem dołączając subskrypcje do submission (sekcja „In-App Purchases and Subscriptions" przy buildzie — patrz pułapka wyżej, to była przyczyna odrzucenia builda 1), potem oczekiwanie na wynik. Zrzuty ekranu — zrobione.
